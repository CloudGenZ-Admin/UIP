...
export default function CulturalForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      interests: interestsArray.join(', '), // Database wants a string
      ...
      volunteering: formData.get('volunteering') === 'on', // Convert to boolean
    ...
    try {
      ...
      alert('You have successfully joined our cultural celebrations! 🎉');
      e.target.reset();
    } catch (error) {
      console.error(error);
