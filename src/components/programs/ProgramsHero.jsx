...
export default function ProgramsHero() {
  return (
    <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden pt-[120px] pb-[160px] px-6">
      {/* Background Gradient */}
      ...
      <div className="relative z-10 text-center max-w-[1000px]">
        ...
        <motion.div 
          ...
          className="bg-white/10 backdrop-blur-md rounded-[2.5rem] p-8 border border-white/20 max-w-3xl mx-auto text-left"
        >
          <h3 className="text-xl font-black mb-2 text-white italic">
