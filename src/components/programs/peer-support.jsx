    ...
    <div className="min-h-screen bg-purple-50 py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <button 
          ...
          className="flex items-center gap-2 text-gray-500 hover:text-purple-600 transition-colors mb-6 font-semibold"
        >
          <svg 
            className="w-5 h-5" 
            fill="none" 
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-sm p-8 md:p-12">
            ...
            <form className="space-y-12" onSubmit={e => e.preventDefault()}>
              ...
              <button type="submit" className="w-full bg-gradient-cta text-white font-bold text-lg py-4 rounded-full hover:opacity-90 transition-opacity shadow-lg bg-purple-600">
                Submit Registration
              </button>
