  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-[120px] pb-[180px] px-6">
      ...
      <div className="relative z-10 text-center max-w-[900px]">
        ...
        >
         {/* A world where LGBTQ+ newcomers, immigrants, and refugees feel safe, supported, and deeply connected —
          not just surviving, but thriving in a community they can call home. */}
        </motion.p>
      </div>
