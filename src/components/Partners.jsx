    ...
    <section className="py-[100px] px-6 bg-[#FAFAFA] overflow-hidden">
      <div className="max-w-[1000px] mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="text-[2.5rem] font-extrabold leading-tight mb-4 text-slate-800">Our Community Partners</h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
          {partners.map((partner, index) => (
            <motion.div 
              ...
              className="px-8 py-6 w-full md:w-auto min-w-[300px] bg-white rounded-2xl shadow-md border border-slate-100 flex items-center justify-center text-center"
            >
