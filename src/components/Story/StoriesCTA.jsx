        ...
        <div className="rounded-3xl p-0.5 shadow-xl" style={{ background: 'linear-gradient(135deg, #b8a7e0, #7dcbb8)' }}>
          <div className="bg-white rounded-[calc(1.5rem-2px)] p-10 md:p-16 text-center">
            ...
            <p className="text-pride-muted text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Your journey can light the way for others. Join our community and help create a world where every LGBTQ+ person can live authentically and safely.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-14">
              ...
              <Link to="/about" className="border-2 border-pride-lavender text-pride-purple font-semibold px-8 py-3.5 rounded-full hover:bg-purple-50 transition-colors">
                Get Involved
              </Link>
            </div>
